...
export default {
  ...
  methods: {
    ...
    nextClick (next) {
      this.$router.push({ path: '/' + next, query: { id: this.$route.query.id, sn: this.$route.query.emptys, mark: this.$route.query.mark, address: this.$route.query.address,type:true} });
    },
    start () {
