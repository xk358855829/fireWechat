...
export default {
    ...
    this.$axios
      ...
      .then(message => {
        ...
        //       })
              ...
              var new_point2 = new BMap.Point(localStorage.getItem('pointlngright'), localStorage.getItem('pointlatright'));
              // var new_point2 = new BMap.Point(120.2282128307, 30.2693046269);
              map.centerAndZoom(new_point2, 15);
              ...
              for (let i = 0; i < that.poinDevice.length; i++) {
                ...
                new_point = new BMap.Point(p0, p1);
                ...
                if (that.poinDevice[i].online=="true") {
                  ...
                  marker[i] = new BMap.Marker(new_point, {
                    icon: deviceIcon
                  });
                } else {
                  console.log(i)
                ...
                that.addMarker(marker[i], new_point)
  ...
  methods: {
      ...
      bal.addEventListener("click", e => {
        ...
        this.poinDevice.forEach(a => {
          if (a.amendLongitude == val.lng && a.amendLatitude == val.lat) {
            ...
            this.mark = a.mark
            this.devId=a.id
            this.auth_info = a.devSnNum
            this.onlinenew = a.online
            console.log(this.onlinenew)
    ...
    nextClick (next) {
      this.$router.push({ path: '/' + next, query: { id: this.devId, sn: this.auth_info, mark: this.mark, address: this.changaddress,type:true} });
    },
    nextClick2 (next) {
